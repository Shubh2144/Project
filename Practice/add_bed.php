...
?><select name="bno" id="cnm" class="form-control" required>
    ...
    <div class="form-row row justify-content-center">
     <div class="form-group col-md-6">
      ...
      <input type="text" name="bn"class="form-control" id="cn" placeholder="" required>
    </div>
    </div>
    <div class="form-row row justify-content-center">
     <div class="form-group col-md-6">
      <label for="cn">Room No</label>
      <input type="text" name="rmno"class="form-control" id="cn" placeholder="" required>
    </div>
    </div>
    <div class="form-row row justify-content-center">
     <div class="form-group col-md-6">
    ...
    <div class="form-row row justify-content-center">
     <div class="form-group col-md-6">
      ...
      <input type="text" name="fa1"class="form-control" id="cn" placeholder="" required>
    </div>
   </div>
  ...
  <div class="form-row row justify-content-center">
    <div class="form-group col-md-6">
      ...
      <input type="text" name="fa2"class="form-control" id="cn" placeholder="" required>
    </div>
  </div>
  <div class="form-row row justify-content-center">
    <div class="form-group col-md-6">
      <label for="cn">Remark</label>
      <input type="text" name="rm"class="form-control" id="cn" placeholder="" required>
    </div>
  </div>
  <div class="form-row row justify-content-center">
    <div class="form-group col-md-6">
      <label for="cn">Charges</label>
      <input type="text" name="ch"class="form-control" id="cn" placeholder="" required>
    </div>
  </div>
  <div class="form-row row justify-content-center">
    <div class="form-group col-md-6">
      <label for="cn">Availability</label>
      <select name="av" id="cn" class="form-control" required>
        <option value=""></option>
...
$sql = "INSERT INTO hospitalbed ( hospitalid, bedno, roomno, type, facility1, facility2, remark, charges, available) VALUES ('$bno', '$bn', '$roomno', '$type', '$f1', '$f2', '$re','$charge', '$avail')";
   $retval = mysql_query($sql, $db);

   if(! $retval) {
      die('Could not enter data');
     echo "<script>alert('Data Cannot Added!'); location.href='hospitalbed.php';</script>";

   }
   else {
     echo "customer Insert";
     echo "<script>alert('Data Added!'); location.href='hospitalbed.php';</script>";
   }
