...
<div class="container">
    <br>
  <div>
    <a href="add_hospi.php" class="btn btn-info float-right font-weight-bold btn-sm" role="button"><i class='fas fa-plus'></i> Add Hospital</a>
  </div>
   ...
   <tr>
      ...
      <td>
        <a href="update_hospi.php?update=<?php echo "$row[hospitalid]";?>"><button class="btn btn-success"><i class="fas fa-edit"></i></button></a>
        <a href="hospital.php?delete=<?php echo "$row[hospitalid]";?>"><button class="btn btn-danger"><i class="far fa-trash-alt"></i></button></a>
      </td>
    </tr>
    <?php
}
