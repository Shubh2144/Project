...
<div class="container">
   ...
   <tr>
      ...
      <td><?php echo "$row[dischargeno]";?></td>
      ...
      <td><?php echo "$row[treatcharges]";?></td>
      <td><?php echo "$row[othercharges]";?></td>
      <td><?php echo "$row[totalcharges]";?></td>
      <td>
        <a href="view_dich.php?view=<?php echo "$row[dischargeno]";?>"><button class="btn btn-success"><i class="fas fa-eye"></i></button></a>
        <a href="report.php?delete=<?php echo "$row[dischargeno]";?>"><button class="btn btn-danger"><i class="far fa-trash-alt"></i></button></a>
      </td>
    </tr>
    <?php
}
...
$db=mysql_connect("localhost","root");
  ...
  if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $re = mysql_query("DELETE FROM hospital WHERE hospitalid=$id", $db);
    if (!$re) {
      echo "<script>alert('Record Not Deleted!'); location.href='hospital.php';</script>";
    }else{
      echo "<script>alert('Hospital Record Deleted!'); location.href='hospital.php';</script>";
    }
  }
  ?>
