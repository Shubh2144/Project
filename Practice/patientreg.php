...
<div class="container">
    <br>
  <div>
    <a href="request_bed.php" class="btn btn-info float-right font-weight-bold btn-sm" role="button"><i class='fas fa-plus'></i> Request to Bed</a>
  </div>
   ...
   <tr>
      ...
      <td><?php echo "$row[dignosis]";?></td>
      <td><?php echo "$row[refdr]";?></td>
      <td><?php echo "$row[registrationdate]";?></td>
      <td><?php echo "$row[status]";?></td>
      <td>
        <a href="patientreg.php?delete=<?php echo "$row[patientid]";?>"><button class="btn btn-danger"><i class="far fa-trash-alt"></i></button></a>
      </td>
    </tr>
    <?php
}
...
$db=mysql_connect("localhost","root");
  ...
  if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $re = mysql_query("DELETE FROM patient WHERE patientid=$id", $db);
    if (!$re) {
      echo "<script>alert('Record Not Deleted!'); location.href='patientreg.php';</script>";
    }else{
      echo "<script>alert('Patient Record Deleted!'); location.href='patientreg.php';</script>";
    }
  }
  ?>
