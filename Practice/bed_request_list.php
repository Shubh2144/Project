...
$db=mysql_connect("localhost","root");
  ...
  if (isset($_GET['delete'])) {
    ...
    if (!$re) {
      echo "<script>alert('Record Not Deleted!'); location.href='bed_request_list.php';</script>";
    }else{
      echo "<script>alert('Patient Record Deleted!'); location.href='bed_request_list.php';</script>";
    }
  }
  ?>
