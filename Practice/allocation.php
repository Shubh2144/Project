...
<div class="container">
    <br>
  <div>
    <a href="allocate_bed.php" class="btn btn-info float-right font-weight-bold btn-sm" role="button"><i class='fas fa-plus'></i>Allocate Bed</a>
    <a href="bed_request_list.php" class="btn btn-info float-right font-weight-bold btn-sm" role="button"><i class='fas fa-plus'></i>Bed Request List</a>
  </div>
   ...
   <tr>
      ...
      <td>
        <a href="allocation.php?delete=<?php echo "$row[allocationno]";?>"><button class="btn btn-danger"><i class="far fa-trash-alt"></i></button></a>
      </td>
    </tr>
    <?php
}
...
$db=mysql_connect("localhost","root");
  ...
  if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $re = mysql_query("DELETE FROM alc WHERE allocationno=$id", $db);
    if (!$re) {
      echo "<script>alert('Record Not Deleted!'); location.href='allocation.php';</script>";
    }else{
      echo "<script>alert('Patient Record Deleted!'); location.href='allocation.php';</script>";
    }
  }
  ?>
